...
"}\n"
"QWidget#widget{\n"
"    background-image: url(:/historia_ventas/wallpaper2you_79585.jpg);\n"
"}")
...
"color: white;")
        ...
        self.boton_filtrar_ventas_posnet.setGeometry(QtCore.QRect(570, 700, 231, 51))
        self.boton_filtrar_ventas_posnet.setCursor(QtGui.QCursor(QtCore.Qt.PointingHandCursor))
...
"background: none;")
        ...
        self.boton_modificar_venta.setGeometry(QtCore.QRect(570, 200, 231, 51))
        self.boton_modificar_venta.setCursor(QtGui.QCursor(QtCore.Qt.PointingHandCursor))
...
"background: none;")
        ...
        self.boton_eliminar_venta.setGeometry(QtCore.QRect(570, 300, 231, 51))
...
"color: #fff;")
        ...
        self.label_resultado_total_ganado.setStyleSheet("font: 12pt \"MS Shell Dlg 2\";\n"
"background: none;\n"
"color: rgb(56, 255, 56);")
        ...
        self.boton_filtrar_ventas_mercadopago.setGeometry(QtCore.QRect(570, 800, 231, 51))
        self.boton_filtrar_ventas_mercadopago.setCursor(QtGui.QCursor(QtCore.Qt.PointingHandCursor))
        self.boton_filtrar_ventas_mercadopago.setStyleSheet("")
        self.boton_filtrar_ventas_mercadopago.setObjectName("boton_filtrar_ventas_mercadopago")
...
"color: white;")
        ...
        self.label_eliminar_venta.setGeometry(QtCore.QRect(560, 350, 251, 31))
        font = QtGui.QFont()
        font.setFamily("MS Shell Dlg 2")
        font.setPointSize(12)
        font.setBold(False)
        ...
        self.label_eliminar_venta.setStyleSheet("font: 12pt \"MS Shell Dlg 2\";\n"
"color: #f00;\n"
"background: none;")
        ...
        self.boton_mostrar_ventas_totales.setCursor(QtGui.QCursor(QtCore.Qt.PointingHandCursor))
        ...
        self.boton_agregar_venta.setGeometry(QtCore.QRect(570, 100, 231, 51))
        ...
        self.label_modificar_venta.setGeometry(QtCore.QRect(560, 250, 251, 31))
        font = QtGui.QFont()
        font.setFamily("MS Shell Dlg 2")
        font.setPointSize(12)
        font.setBold(False)
        ...
        self.label_modificar_venta.setStyleSheet("font: 12pt \"MS Shell Dlg 2\";\n"
"color: #f00;\n"
"background: none;")
        ...
        self.label_total_ganado.setStyleSheet("font: 12pt \"MS Shell Dlg 2\";\n"
"color: #fff;\n"
"background: none;")
        ...
        self.boton_consultar_ganancias.setGeometry(QtCore.QRect(570, 400, 231, 51))
        self.boton_consultar_ganancias.setCursor(QtGui.QCursor(QtCore.Qt.PointingHandCursor))
...
"color: #fff;")
        ...
        self.input_precio_unitario.setStyleSheet("border-radius: 10px;\n"
"padding: 7px;\n"
"color: #fff;")
        ...
        self.label_campos_no_validos.setStyleSheet("font: 12pt \"MS Shell Dlg 2\";\n"
"color: #f00;\n"
"background: none;")
...
"color: #fff;")
        ...
        self.label_precio_unitario.setStyleSheet("font: 12pt \"MS Shell Dlg 2\";\n"
"color: #fff;\n"
"background: none;")
...
"color: #fff;")
        ...
        self.boton_filtrar_ventas_efectivo.setGeometry(QtCore.QRect(570, 600, 231, 51))
        self.boton_filtrar_ventas_efectivo.setCursor(QtGui.QCursor(QtCore.Qt.PointingHandCursor))
        self.boton_filtrar_ventas_efectivo.setStyleSheet("")
        self.boton_filtrar_ventas_efectivo.setObjectName("boton_filtrar_ventas_efectivo")
...
"background: none;")
    ...
    def retranslateUi(self, HistorialVentas):
        ...
        self.label_fecha_no_valida.setText(_translate("HistorialVentas", "Ingrese fechas validas"))
        self.eleccion_efectivo.setText(_translate("HistorialVentas", "Efectivo"))
        self.boton_filtrar_ventas_posnet.setText(_translate("HistorialVentas", "Filtrar Ventas Posnet"))
        self.label_tipo_pago_consulta.setText(_translate("HistorialVentas", "Tipo de pago:"))
        ...
        self.boton_confirmar_registro.setText(_translate("HistorialVentas", "CONFIRMAR"))
        ...
        self.boton_modificar_venta.setText(_translate("HistorialVentas", "Modificar Venta"))
        self.label_fecha.setText(_translate("HistorialVentas", "Fecha (dia, mes, año):"))
        self.boton_confirmar_modificacion.setText(_translate("HistorialVentas", "CONFIRMAR"))
        self.boton_eliminar_venta.setText(_translate("HistorialVentas", "Eliminar Venta"))
        self.boton_filtrar_ventas_mercadopago.setText(_translate("HistorialVentas", "Filtrar Ventas MP"))
        self.eleccion_mercadopago.setText(_translate("HistorialVentas", "MercadoPago"))
        self.eleccion_mercadopago_2.setText(_translate("HistorialVentas", "MercadoPago"))
        self.boton_mostrar_ventas_totales.setText(_translate("HistorialVentas", "Mostrar Ventas Totales"))
        self.boton_agregar_venta.setText(_translate("HistorialVentas", "Agregar Venta"))
        self.label_total_ganado.setText(_translate("HistorialVentas", "DINERO INGRESADO ($):"))
        self.boton_consultar_ganancias.setText(_translate("HistorialVentas", "Consultar Ingresos"))
        self.eleccion_posnet.setText(_translate("HistorialVentas", "Posnet"))
        self.label_precio_unitario.setText(_translate("HistorialVentas", "Precio unitaro:"))
        self.label_stock.setText(_translate("HistorialVentas", "Cantidad Vendida:"))
        self.boton_filtrar_ventas_efectivo.setText(_translate("HistorialVentas", "Filtrar Ventas Efectivo"))
